"""
Django settings for iclass_server project.
...
SECRET_KEY = "django-insecure-86hmklej0p2y$zh-lnjnzq+a^0#c@p++uf2qz7v(io-_@_v)-x"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["iclass.com", "127.0.0.1", "localhost"]
...
ROOT_URLCONF = "iclass_server.urls"
