    ...
    <el-dialog v-model="addStudentDialogVisible" title="添加学生" width="30%">
      <el-form>
        <el-form-item label="学生ID">
          <el-input v-model="studentIdToAdd" placeholder="请输入要添加的学生的ID"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
...
import { ElMessage, ElCard, ElAvatar, ElTag, ElButton, ElEmpty, ElDialog, ElForm, ElFormItem, ElInput } from 'element-plus';
